...
if (hi > -1) {
  document.getElementById("chat-area").innerHTML += "GLaDOS: Hello and, again, welcome to the Aperture Science computer-aided enrichment center.";
}

else if (how > -1) {
    document.getElementById("chat-area").innerHTML += "GLaDOS: Im doing fine but I've been really busy being dead. You know, after you MURDERED ME.";
}
else if (name > -1) {
    document.getElementById("chat-area").innerHTML += "GLaDOS: I am the Genetic Lifeform and Disk Operating System otherwise known as GLaDOS";
}
else if (old > -1) {
    document.getElementById("chat-area").innerHTML += "GLaDOS: I am approximently 9999999999999999999999999999999999999999999999999999999999999999999999999999999999 -error can not complete query";
}
else if (song > -1) {
    ...
    document.getElementById("chat-area").innerHTML += "GLaDOS: please, state something actually meaningful.";
}
